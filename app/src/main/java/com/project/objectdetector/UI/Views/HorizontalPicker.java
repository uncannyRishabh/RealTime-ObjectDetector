...
//        paint.setTypeface(ResourcesCompat.getFont(context,R.font.roboto_regular));
        ...
        adjustScrollerX = new OverScroller(context, new AnticipateOvershootInterpolator(2f,.2f));
...
//                textPaint.setColor(getTextColor(i));
                ...
                if (i == selectedItem) {
                    ...
                    textPaint.setColor(ContextCompat.getColor(getContext(), R.color.theme_primary_dark)); //MODIFY SELECTED TEXT COLOR
                    rectPaint.setBlendMode(BlendMode.SRC);
                    rectPaint.setColor(ContextCompat.getColor(getContext(), R.color.theme_primary_light)); //MODIFY PILL COLOR
                    canvas.drawRoundRect(background, 100, 100, rectPaint);
                }
